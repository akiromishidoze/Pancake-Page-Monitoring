...
export function BotCakePageList({ pages }: { pages: BotCakePage[] }) {
  ...
  return (
    <div className="mt-4">
      ...
      />
      <div className="mt-2 max-h-48 overflow-auto rounded border border-slate-700">
        <table className="min-w-full text-xs">
          ...
          <tbody className="divide-y divide-slate-800">
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={3} className="px-2 py-4 text-center text-slate-500">No pages match &quot;{query}&quot;</td>
              </tr>
            )}
          </tbody>
        </table>
