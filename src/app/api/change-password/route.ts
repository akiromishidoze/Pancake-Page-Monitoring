...
export async function POST(req: Request) {
  try {
    ...
    const storedEmail = getSetting('auth_email') || 'admin';
    const storedPassword = getSetting('auth_password') || 'admin';
