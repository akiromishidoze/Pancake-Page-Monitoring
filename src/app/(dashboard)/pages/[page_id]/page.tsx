...
export default async function Page({
  ...
  try {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="dashboard-data rounded-lg border border-red-800 bg-red-950/30 p-6 text-red-400" role="alert">
          Could not load page history. The database may be temporarily unreachable.
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionErrorBoundary title="Page Status">
      ...
      <SectionErrorBoundary title="Uptime & Incidents">
        <div className="grid grid-cols-3 gap-4">
          <div className="dashboard-data rounded-lg border border-slate-800 bg-slate-900 p-4">
      ...
      <SectionErrorBoundary title="Response Time & Failures">
        <div className="grid grid-cols-3 gap-4">
          <div className="dashboard-data rounded-lg border border-slate-800 bg-slate-900 p-4">
      ...
      <SectionErrorBoundary title="Recent History">
        <div className="dashboard-data rounded-lg border border-slate-800 bg-slate-900 p-4">
